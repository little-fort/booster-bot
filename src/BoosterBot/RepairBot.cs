    ...
    internal class RepairBot : BaseBot
    {
        ...
        public void StartRepair(bool firstRun = true)
        {
            ...
            if (mode == 2) // Ladder
                ...
                [
                    new(Strings.Repair_Ladder_BTN_PLAY, [_maps.REF_LADD_BTN_PLAY], [_game.CanIdentifyMainMenu]),
                    new(Strings.Repair_Conquest_LOBBY_INFINITE + Environment.NewLine + Environment.NewLine + Strings.Repair_Conquest_LOBBY_NOTE, [_maps.REF_CONQ_LBL_LOBBY_INFINITE_1, _maps.REF_CONQ_LBL_LOBBY_INFINITE_4], [() => _game.CanIdentifyConquestLobbyInfinite(false)]),
                    new(Strings.Repair_Conquest_LOBBY_GOLD + Environment.NewLine + Environment.NewLine + Strings.Repair_Conquest_LOBBY_NOTE, [_maps.REF_CONQ_LBL_LOBBY_GOLD_1, _maps.REF_CONQ_LBL_LOBBY_GOLD_4], [() => _game.CanIdentifyConquestLobbyGold(false)]),
                    new(Strings.Repair_Conquest_LOBBY_SILVER + Environment.NewLine + Environment.NewLine + Strings.Repair_Conquest_LOBBY_NOTE, [_maps.REF_CONQ_LBL_LOBBY_SILVER_1, _maps.REF_CONQ_LBL_LOBBY_SILVER_4], [() => _game.CanIdentifyConquestLobbySilver(false)]),
                    new(Strings.Repair_Conquest_LOBBY_PG + Environment.NewLine + Environment.NewLine + Strings.Repair_Conquest_LOBBY_NOTE, [_maps.REF_CONQ_LBL_LOBBY_PG_1, _maps.REF_CONQ_LBL_LOBBY_PG_3, _maps.REF_CONQ_LBL_ENTRANCE_FEE], [() => _game.CanIdentifyConquestLobbyPG(false), () => _game.CanIdentifyConquestEntranceFee(false)]),
